...
function number1() {
	for (i of arr) {
		let current = i.split("x")
		let amount = current[0] * current[1] * current[2]
		total += amount
	}
	document.getElementById("number1").textContent = total
	total = 0
}
...
function number2() {
	for (i of arr) {
		let current = i.split("x")
		let currentSorted = current.sort((a, b) => a - b)
		let Longest = Number(currentSorted[2])
		let Middle = Number(currentSorted[1])
		let Shortest = Number(currentSorted[0])
		let wrapping = ((2*Shortest) + Longest) * ((2 * Middle) + 2*Shortest)
		totalWrapping += wrapping
	}
	document.getElementById("number2").textContent = totalWrapping
...
function number3() {
	for (i of arr) {
		...
		let Middle = Number(currentSorted[1])
		let Shortest = Number(currentSorted[0])
		let part1 = (2 * Shortest + Longest)
		let part2 = (2 * Middle + 2 * Shortest)
	...
	document.getElementById("number3").textContent = totalPaper
	totalPaper = 0
}
...
function number4(){
	for(i of arr){
		let current = i.split("x")
		let currentSorted = current.sort((a, b) => a - b)
		let Longest = currentSorted[2]
		let Middle = currentSorted[1]
		let Shortest = currentSorted[0]
		let ribbon = (2 * Shortest) + (2 * Middle) + (2 * Shortest) + (2 * Longest) + (Shortest * Middle * Longest)
		totalRibbon += ribbon
	}
	document.getElementById("number4").textContent = totalRibbon
	totalRibbon = 0
}